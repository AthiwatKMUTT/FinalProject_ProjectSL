...
# Load Keras model
model = load_model('select-mode/mode1/model/Num910.h5')
...
labels_dict = {0: '6', 1: '7', 2: '8', 3: '9', 4: '10'}
...
def show_final_score():
    ...
    next_button = Button(label_leftbot, text="Back to select page", font=("Helvetica", 24), command=backTopage)
...
def backTopage():
    script_path = os.path.join(os.path.dirname(__file__), 'D:\KMUTT_Files\FinalProject4\Pre-Program\SelectChallenge.py')
...
back_button = Button(windows, text='Back to Main Page', font=("Helvetica", 12), width=20, command=backTopage)
