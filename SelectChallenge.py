...
windows = tk.Tk()
windows.title('Select Challenge Page')
...
bg_image = Image.open("./image/19.jpg")
...
bg_image_leftbot = Image.open("./image/bg-left-bot.png")
bg_image_tk_leftbot = ImageTk.PhotoImage(bg_image_leftbot)

button1 = Button(button_frame, text='Mode 1', font=("Helvetica", 24), width=20,bd=10,relief='groove', command=lambda: open_page('./select-mode/mode1/Trainingpage.py'))
button1.pack(pady=(175,25), anchor='center', padx=(150, 150))
button2 = Button(button_frame, text='Mode 2', font=("Helvetica", 24), width=20,bd=10,relief='groove', command=lambda: open_page('./select-mode/mode2/Trainingpage.py'))
button2.pack(pady=25, anchor='center', padx=(150, 150))
button3 = Button(button_frame, text='Mode 3', font=("Helvetica", 24), width=20,bd=10,relief='groove', command=lambda: open_page('./select-mode/mode3/Trainingpage.py'))
button3.pack(pady=25, anchor='center', padx=(150, 150))
button4 = Button(button_frame, text='Mode 4', font=("Helvetica", 24), width=20,bd=10,relief='groove', command=lambda: open_page('./select-mode/mode4/Trainingpage.py'))
button4.pack(pady=25, anchor='center', padx=(150, 150))
button5 = Button(button_frame, text='Mode 5', font=("Helvetica", 24), width=20,bd=10,relief='groove', command=lambda: open_page('./select-mode/mode5/Trainingpage.py'))
