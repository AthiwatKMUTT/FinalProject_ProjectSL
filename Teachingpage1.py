...
windows.configure(bg='red')  # Change the overall background color
...
label_img = tk.Label(windows, bg="red")  # Set background to white
...
# List of video names
video_names = ["./videomode1/01.mp4", "./videomode1/02.mp4", "./videomode1/03.mp4", "./videomode1/04.mp4", "./videomode1/05.mp4",
               "./videomode1/06.mp4", "./videomode1/07.mp4", "./videomode1/08.mp4", "./videomode1/09.mp4", "./videomode1/10.mp4"]
...
instructions = (
    "วิธีการใช้งาน\n"
    "สามารถกดเลือกดูวิดีโอสอน ตามคำศัพท์ที่ต้องการ\n"
    "- กด D เพื่อดูวิดีโอถัดไป\n"
    "- กด A เพื่อย้อนกลับ"
)
instructions_label = Label(windows, text=instructions, font=("Helvetica", 18), bg="red", justify='center')
